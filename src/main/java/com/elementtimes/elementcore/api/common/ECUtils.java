...
public class ECUtils {
    ...
    public static FluidUtils fluid = FluidUtils.getInstance();

    public static RecipeUtils recipe = RecipeUtils.getInstance();

    public static ReflectUtils reflect = ReflectUtils.getInstance();

    public static BlockUtils block = BlockUtils.getInstance();
